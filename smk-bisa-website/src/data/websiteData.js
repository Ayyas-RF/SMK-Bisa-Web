...
export const specialAdvantages = [
  { icon: '💰', title: "Uang Saku", desc: "Peserta mendapat uang saku selama program" },
  { icon: '🚀', title: "Project Real", desc: "Mengerjakan project nyata dari industri" },
  { icon: '🤝', title: "Kolaborasi UMKM", desc: "Kesempatan berkolaborasi dengan UMKM" },
];
