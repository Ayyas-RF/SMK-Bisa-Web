          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-black p-8 rounded-lg border border-orange-500/20 hover-lift" data-aos="fade-right" data-aos-delay="200">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold">{programs.prakerin.title}</h3>
              </div>
              
              <div className="space-y-4 mb-6">
                {programs.prakerin.details.map((detail, index) => (
                  <div key={index}>
                    <h4 className="font-bold text-orange-500 mb-2">{detail.subtitle}</h4>
                    {detail.text && <p className="text-gray-300">{detail.text}</p>}
                    {detail.list && (
            ...
            <div className="bg-black p-8 rounded-lg border border-orange-500/20 hover-lift" data-aos="fade-left" data-aos-delay="200">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold">{programs.affiliator.title}</h3>
              </div>
