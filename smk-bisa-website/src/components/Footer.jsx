...
const Footer = () => {
  return (
    <footer
      id="kontak"
      className="bg-gray-900 py-12 border-t border-orange-500/20"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Divisi edukasi vokasi digital ALC Group yang berkomitmen mencetak
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Tentang", "Program", "Testimoni", "Kontak"].map(
                (link, index) => (
                  <li key={index}>
                    <a
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-400">
                  Jl. Melong Cijerah VI No. 5, Kecamatan Bandung Kulon, Kota
                  Bandung
                </span>
              </div>
              <div className="flex items-center">
        ...
        <div className="border-t border-orange-500/20 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            ...
            <a href="#" className="text-orange-500 hover:text-orange-400 ml-2">
              Kebijakan Privasi
            </a>
          </p>
        </div>
