...
import { Phone, MessageSquareWarning } from "lucide-react";
	...
	return (
		<section className="py-16 bg-black">
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
				<div
					className="bg-gradient-to-r from-orange-500/20 to-orange-600/20 p-8 rounded-lg border border-orange-500/20 hover-lift"
					data-aos="zoom-in"
					data-aos-delay="200"
				>
					...
					<MessageSquareWarning />
						...
						<p className="text-gray-300">
							Hanya tersedia 50 slot untuk periode ini. Daftarkan diri Anda
							sekarang sebelum kehabisan!
						</p>
					</div>

					<p className="text-xl text-gray-300 mb-8 animate-fade-in-up">
						Bergabunglah dengan ribuan siswa yang sudah merasakan dampak nyata
						dari program SMK Bisa. Raih kesempatan emas untuk mengembangkan
						skill digital dan meraih penghasilan di usia muda!
					</p>
