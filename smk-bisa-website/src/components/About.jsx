...
import { BookOpen, Users, Award, Target, TrendingUp, CheckCircle } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {advantages.map((item, index) => {
              ...
              return (
                ...
                >
                  {IconComponent && <IconComponent className="text-orange-500 mb-4" size={48} />}
          ...
          <div className="bg-gradient-to-r from-orange-500/10 to-orange-600/10 p-8 rounded-lg border border-orange-500/20" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {specialAdvantages.map((item, index) => (
                <div key={index} className="text-center" data-aos="flip-up" data-aos-delay={300 + index * 100}>
                  <div className="text-3xl font-bold text-orange-500 mb-2">{item.icon}</div>
